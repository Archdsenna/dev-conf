...
"       @sais+待添加括号      : 整句添加括号, 例如sais(, 在单词周围加上括号对()
"        Tips: sais命令按的时候,不要一次按完,否则不生效,先按sa,然后按i,最后按s,比如: sa i s这样的节奏
